...
class SVD(object):
    """Matrix factorization based on svd algo
    """
    def __init__(self, matrix, K, lam = 0.1, Xinit = None, Winit = None, 
                 learning_rate = 0.5, max_iter = 1000, print_every = True, user_based = 0, ):
        super(SVD, self).__init__()

        self.raw = matrix.copy()
    ...
    def normalize(self):
        """Normalize matrix before training
